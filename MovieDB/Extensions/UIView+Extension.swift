...
extension UIView {
    ...
    func setHeightMultiflier(with view: NSLayoutDimension, multiflier: CGFloat) {
        translatesAutoresizingMaskIntoConstraints = false
        heightAnchor.constraint(equalTo: view, multiplier: multiflier).isActive = true
    }
    ...
    func addGradient(startColor: UIColor, endColor: UIColor, cornerRadius: CGFloat = 0) {
