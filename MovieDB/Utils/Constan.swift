...
struct Constan {
    ...
    struct Url {
        static var urlForMovie: URL? {
            return URL(string: "https://api.themoviedb.org/3/discover/movie?api_key=\(Constan.apiKey)&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1")
        }
        ...
        static let genreUrl = "https://api.themoviedb.org/3/genre/movie/list?api_key=\(Constan.apiKey)&language=en-US"
